...
@section('content')
    <div name="card1" class="bg-silver flex items-center justify-between px-20 py-10">
    ...
    <div name="card3" class="p-20 flex items-center gap-5">
        <div>
    ...
    <div class="bg-silver flex p-20 justify-between">
        <div>
    ...
    <div class="bg-silver p-20 space-y-3">
