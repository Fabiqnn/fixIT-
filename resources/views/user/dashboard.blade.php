...
<div class="h-auto lg:h-[calc(100vh-14rem)] mx-3 border border-gray-300 p-0 rounded-lg shadow-md flex flex-col lg:flex-row overflow-hidden mb-5">
    <!-- Sidebar -->
    ...
    <!-- Detail Panel -->
    <div id="detail-panel" class="flex-1 bg-gray-50 p-4 sm:p-6 overflow-y-auto h-full">
