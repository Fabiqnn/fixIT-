...
<div x-data="{ imageUrl: null }" 
    ...
    <label id="drop-area" x-ref="dropArea"
           class="cursor-pointer border-2 border-dashed border-gray-300 rounded-lg h-40 w-120 mx-auto flex items-center justify-center text-gray-400 text-sm hover:border-green-500 hover:text-green-500 transition relative overflow-hidden">
...
<div class="space-y-4 mt-6">
    <!-- Fasilitas Dropdown -->
    <div x-data="{ open: false, selected: 'Pilih Fasilitas' }" class="relative w-full">
    ...
    <div class="grid grid-cols-3 gap-4">
        <!-- Gedung -->
        <div x-data="{ open: false, selected: 'Pilih Gedung' }" class="relative">
            ...
            <ul x-show="open" @click.away="open = false"
                class="absolute z-10 w-full mt-1 bg-white border border-gray-300 rounded-md shadow-lg max-h-60 overflow-auto">
                <li @click="selected = 'JTI'; open = false" class="px-4 py-2 hover:bg-green-100 cursor-pointer">JTI</li>
                <li @click="selected = 'FT'; open = false" class="px-4 py-2 hover:bg-green-100 cursor-pointer">FT</li>
                <li @click="selected = 'FMIPA'; open = false" class="px-4 py-2 hover:bg-green-100 cursor-pointer">FMIPA</li>
            </ul>
        </div>

        <!-- Ruangan -->
        <div x-data="{ open: false, selected: 'Pilih Ruangan' }" class="relative">
            ...
            <ul x-show="open" @click.away="open = false"
                class="absolute z-10 w-full mt-1 bg-white border border-gray-300 rounded-md shadow-lg max-h-60 overflow-auto">
                <li @click="selected = 'LPR 1'; open = false" class="px-4 py-2 hover:bg-green-100 cursor-pointer">LPR 1</li>
                <li @click="selected = 'LPR 2'; open = false" class="px-4 py-2 hover:bg-green-100 cursor-pointer">LPR 2</li>
                <li @click="selected = 'LPR 3'; open = false" class="px-4 py-2 hover:bg-green-100 cursor-pointer">LPR 3</li>
            </ul>
        </div>

        <!-- Lantai -->
        <div x-data="{ open: false, selected: 'Pilih Lantai' }" class="relative">
            ...
            <ul x-show="open" @click.away="open = false"
                class="absolute z-10 w-full mt-1 bg-white border border-gray-300 rounded-md shadow-lg max-h-60 overflow-auto">
                <li @click="selected = '1'; open = false" class="px-4 py-2 hover:bg-green-100 cursor-pointer">1</li>
                <li @click="selected = '2'; open = false" class="px-4 py-2 hover:bg-green-100 cursor-pointer">2</li>
                <li @click="selected = '3'; open = false" class="px-4 py-2 hover:bg-green-100 cursor-pointer">3</li>
                <li @click="selected = '4'; open = false" class="px-4 py-2 hover:bg-green-100 cursor-pointer">4</li>
                <li @click="selected = '5'; open = false" class="px-4 py-2 hover:bg-green-100 cursor-pointer">5</li>
            </ul>
        </div>
    </div>
</div>
