...
@section('content')
    ...
    <div class="container mx-auto px-4 py-8">
        ...
        <div class="prose max-w-none text-gray-700">
            <p>
                Selamat datang di halaman panduan <strong>fixIT!</strong> Di sini Anda akan menemukan informasi tentang bagaimana cara menggunakan platform ini untuk melaporkan masalah dan mengelola fasilitas kampus.
            </p>
            ...
            <p>Anda dapat memantau status laporan Anda di halaman <strong>"Laporan Saya"</strong>. Status laporan akan berubah dari <em>"Menunggu"</em>, <em>"Diproses"</em>, hingga <em>"Selesai"</em>.</p>
