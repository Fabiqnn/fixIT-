...
@else
    <form action="{{url('/admin/pelaporan/'. $pelaporan->laporan_id . '/up_dec')}}" method="POST" id=form-dec>
        @csrf
        @method('PUT')
        <div class="space-y-6">
            ...
            <div class="p-5 flex flex-col justify-center gap-6">
                <div class="p-5 bg-warning text-blackshade1 rounded space-y-3">
                    ...
                    <p>Apakah Anda ingin menolak data seperti di bawah ini?</p>
                </div>
